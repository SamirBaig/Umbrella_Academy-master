...
class Funfact extends Component{
    ...
    render(){
        ...
        let data = [
            {img: 'funfact-project.png', countNum : 15, countTitle: 'Projects' },
            {img: 'funfact-clients.png', countNum : 15, countTitle: 'Clients' },
            {img: 'funfact-success.png', countNum : 10, countTitle: 'Success' },
            {img: 'funfact-award.png', countNum : 10, countTitle: 'Awards' }
        ];
