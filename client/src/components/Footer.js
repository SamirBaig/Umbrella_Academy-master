                    ...
                    <div className="col-xl-3 col-lg-3 col-md-12">
                      <div className="footer-intro-wrapper">
                        ...
                        <div className="footer-desc">
                          Unlock your potential with our innovative
                          platform. Designed to bring knowledge to your
                          fingertips from the comfort of your own home, our
                          personalized learning journey empowers you to master
                      ...
                      <div className="footer-widget mb-0">
                        ...
                        <div className="footer-widget__content">
                          ...
                          <ul className="contact-details">
                            <li>
                              <span>P:</span>+923154264339
                            </li>
                            <li>
                              <span>F:</span>090078601
                            </li>
                            <li>
                              <span>E:</span>samirbaig@demo.com
                            </li>
                          </ul>
                        </div>
                      </div>
