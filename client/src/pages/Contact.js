                        ...
                        <div className="contact-information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span className="text"><span>Comsats University Islamabad, Lahore</span></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-telephone-outline" /></span>
                                    <span className="text"><a href="tel:1234567890">+923154264339</a><a href="tel:1234567890">090078601</a></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-email-outline" /></span>
                                    <span className="text"><a href="mailto:info@example.com">samirbaig@demo.com</a><a href="mailto:info@example.com">amnaaltaf@demo.com</a></span>
                                </li>
                            </ul>
                        </div>
                        </div>
